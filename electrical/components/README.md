...
| [`current-shunt/`](./current-shunt/) | Bourns CSS4J-4026K-2L00F, 2 mΩ four-terminal shunt | candidate proposed, not frozen | archive datasheet after selection; validate land pattern |
