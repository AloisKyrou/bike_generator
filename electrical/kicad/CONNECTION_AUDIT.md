...
| `POT_MOSI` | `U2 GPIO7` → `U3 SI` |
| `POT_MISO` | `U3 SO` → `U2 GPIO4` |
| `CC_A`, `CC_W`, `CC_B` | canal 0 du DFR0520 → `J1` et points de test dédiés |
...
- canal 1 du DFR0520, inutilisé dans la V1 ;
- broches `GPIO8` et `GPIO9_BOOT` du Beetle ;
- empreinte du Beetle et interrupteur `S1` ;
