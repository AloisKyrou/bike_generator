...
Il référence actuellement cinq feuilles vides :
...
Aucun port hiérarchique n'est encore créé. C'est volontaire : leurs noms et
leurs directions dépendront des mesures encore manquantes sur le buck et sur
les masses.
...
Résultat de cette étape : cinq feuilles relues aux pages 2 à 6, aucun port
incohérent, aucune violation ERC et un rendu entièrement contenu dans le cadre
A4. Ces résultats décrivent uniquement une hiérarchie vide ; ils ne valident
pas encore un circuit électrique.
